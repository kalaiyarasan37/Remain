...
const ReminderListScreen = ({ navigation }) => {
  ...
  const isOverdue = (dateTime, isCompleted) => {
    return !isCompleted && new Date(dateTime) < new Date();
  };
    ...
    return (
      <View
        style={[
          ...
          isOverdue(item.dateTime, item.isCompleted) && !isDeletedItem && styles.cardOverdue,
        ...
        <View
          style={[
            ...
            isDeletedItem
              ...
              : isOverdue(item.dateTime, item.isCompleted)
              ? styles.colorBarOverdue
        ...
        <View style={styles.cardContent}>
          <View style={styles.cardHeader}>
            ...
            {isOverdue(item.dateTime, item.isCompleted) && !isDeletedItem && (
